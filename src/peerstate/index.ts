...
[ ] 7. Expire keys and handle key rotation
  [ ] a. create action for changing secret key that encrypts the old key
  [ ] b. create action for re-issuing id public key
  [ ] c. make sure keys expire
